            ...
            <div class="col-md-6">
                <div class="box">
                    ...
                    <div class="button-box">
                        ...
                        <form id="login" class= "f1" action="userlogincheck.php" method="POST">
                       ...
                       <center> <a href='forgotuser.html'  style="color:white;"> Forgot Password ?</a></center>
                    </form>
                        <form id="register" class= "f2" action="userinputdatabase.php" method="POST">
                        ...
                        Email-id:<br>
                            ...
                            <input type="checkbox"  name="f1" value="S">
                               ...
                               How do you get updated about tech news? (Optional)<br><br>
                            <input type="checkbox"  name="n1" value="A">
                               <label > Articles</label>
                               <input type="checkbox"  name="n2" value="S">
                               <label > Social Media</label>
                               <input type="checkbox"   name="n3" value="N">
                               <label > News</label>
                               <input type="checkbox"  name="n4" value="O">
                               <label > Others...</label><br><br>
