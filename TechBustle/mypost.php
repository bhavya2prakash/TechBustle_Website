 ...
 <div class="col-sm-7" id="owl">
            ...
            /*if(!$conn){
               ...
               while($row=mysqli_fetch_assoc($result)){
                    ...
                    */
                 $sql="SELECT * FROM `feed` WHERE `eroll`= $rol ORDER BY `date` desc";
                $result=mysqli_query($conn, $sql);
...
if("<?php echo $s ;?>"=="jpg" ||"<?php echo $s ;?>"=="jpeg"||"<?php echo $s ;?>"=="png"  ){
    var a= document.createElement('p');
             ...
             // gd.innerHTML="<?php echo $h;?>"
               ...
               l.innerHTML='<i class = "fa fa-trash fa-2x" aria-hidden="true"></i>';
           ...
           ?>
                    ...
                    <div class="outer">
                    <?php $x=-1;while($row2=mysqli_fetch_assoc($result2)){
                    $f2=$row2['roll'];
                    $s2=$row2['name'];
                    $h2=$row2['email'];
                    $d2=$row2['insname'];
