...
<a href="logout.php"><i class="fa fa-sign-out" aria-hidden="true"></i><span>Log Out</span></a>
            ...
            /*if(!$conn){
                ...
                $sql="SELECT `DT`, `roll`, `name`, `email`, `insname`, `desg`, `inslink`, `techint`, `post` FROM `expertreg` WHERE `verify`=1";
                ...
                while($row=mysqli_fetch_assoc($result)){
                    ...
                    <table>
                        ...
                        <tr><td></td><td> <button class="button button1" onclick= deleteex()>Delete Account</button></td><tr>
                    </table></div>
...
<body>
    <script>
        function deleteex(){
         ...
         if (r == true) {
            window.location='deleteexpert.php?roll=<?php echo $e2;?>' ;
         } 
